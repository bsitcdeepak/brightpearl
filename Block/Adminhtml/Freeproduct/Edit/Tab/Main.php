...
namespace Bsitc\Brightpearl\Block\Adminhtml\Freeproduct\Edit\Tab;

/**
 * Freeproduct edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('freeproduct');
        ...
        $fieldset->addField( 'freesku', 'text',
            [
                'name' => 'freesku',
                'label' => __('Free Product SKU'),
                'title' => __('Free Product SKU'),
				'required' => true,
                'disabled' => $isElementDisabled
            ]
        );
