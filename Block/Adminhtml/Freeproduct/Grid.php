...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Bsitc\Brightpearl\Model\freeproductFactory
     */
     ...
     * @param \Bsitc\Brightpearl\Model\freeproductFactory $freeproductFactory
    ...
    {
        $collection = $this->_freeproductFactory->create()->getCollection();
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('freesku',[
				'header' => __('Free Product SKU'),
				'index' => 'freesku',
			]
		);
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('freeproduct');
    ...
    /**
     * @param \Bsitc\Brightpearl\Model\freeproduct|\Magento\Framework\Object $row
     * @return string
     */
