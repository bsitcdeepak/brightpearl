...
namespace Bsitc\Brightpearl\Block\Adminhtml\Splitsku\Edit\Tab;

/**
 * Splitsku edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('splitsku');
        ...
        $fieldset->addField('splitsku','textarea',[
                'name' => 'splitsku',
                'label' => __('Split Sku'),
                'title' => __('Split Sku'),
                'disabled' => $isElementDisabled
