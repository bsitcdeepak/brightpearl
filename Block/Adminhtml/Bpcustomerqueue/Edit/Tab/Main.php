...
namespace Bsitc\Brightpearl\Block\Adminhtml\Bpcustomerqueue\Edit\Tab;

/**
 * Bpcustomerqueue edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('bpcustomerqueue');
