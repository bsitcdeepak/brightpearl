...
class Savetransitmapping extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (count($all_rows)>0) {
                ...
                $table = $resource->getTableName('bsitc_transittime_shipping_mapping');
                $connection->truncateTable($table);
                $connection->insertMultiple($table, $all_rows);
                $this->messageManager->addSuccess(__('File has been successfully uploaded.'));
            }
        }
        return $resultRedirect->setPath('*/transitmapping/');
    }
}
