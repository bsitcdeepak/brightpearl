...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Bsitc_Brightpearl::Bpcurrency')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Bsitc\Brightpearl\Model\Bpcurrency');
        ...
        $this->_coreRegistry->register('bpcurrency', $model);
