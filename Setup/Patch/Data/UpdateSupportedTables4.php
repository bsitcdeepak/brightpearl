...
class UpdateSupportedTables4 implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function getCustomTables()
    {
        ...
        $tables['bsitc_brightpearl_skureplacement']  = $this->moduleDataSetup->getConnection()
            ->newTable($this->moduleDataSetup->getTable('bsitc_brightpearl_skureplacement'))
            ...
            ->addColumn('rsku', Table::TYPE_TEXT, 255, ['default' => null], 'rsku')
